...
public class FaceWordTest {
    ...
    @Test
    void testVertexOutOfUpperBoundException() {
        try {
            FaceWord faceWord = FaceWord.parse("4/5/6", 1);
            faceWord.checkIndices(3, 3, 3, 1, 1);
            Assertions.fail();
        } catch (FaceWordIndexException exception) {
            String expectedMessage = "Error parsing OBJ file on line: 1. Exception in face argument 1: vertex index out of bounds.";
            Assertions.assertEquals(expectedMessage, exception.getMessage());
        }
    }

    @Test
    void testVertexOutOfLowerBoundException() {
        try {
            FaceWord faceWord = FaceWord.parse("-42/2/2", 1);
            faceWord.checkIndices(3, 3, 3, 1, 1);
            Assertions.fail();
        } catch (FaceWordIndexException exception) {
            String expectedMessage = "Error parsing OBJ file on line: 1. Exception in face argument 1: vertex index out of bounds.";
    ...
    @Test
    void testTextureVertexOutOfUpperBoundException() {
        try {
            FaceWord faceWord = FaceWord.parse("2/5/2", 1);
            faceWord.checkIndices(3, 3, 3, 1, 1);
            Assertions.fail();
        } catch (FaceWordIndexException exception) {
            String expectedMessage = "Error parsing OBJ file on line: 1. Exception in face argument 1: texture vertex index out of bounds.";
            Assertions.assertEquals(expectedMessage, exception.getMessage());
        }
    }

    @Test
    void testTextureVertexOutOfLowerBoundException() {
        try {
            FaceWord faceWord = FaceWord.parse("4/-5/6", 1);
            faceWord.checkIndices(6, 6, 6, 1, 1);
            Assertions.fail();
        } catch (FaceWordIndexException exception) {
            String expectedMessage = "Error parsing OBJ file on line: 1. Exception in face argument 1: texture vertex index out of bounds.";
            Assertions.assertEquals(expectedMessage, exception.getMessage());
    ...
    @Test
    void testNormalOutOfUpperBoundException() {
        try {
            FaceWord faceWord = FaceWord.parse("4/5/6", 1);
            faceWord.checkIndices(5, 5, 5, 1, 1);
            Assertions.fail();
        } catch (FaceWordIndexException exception) {
            String expectedMessage = "Error parsing OBJ file on line: 1. Exception in face argument 1: normal index out of bounds.";
            Assertions.assertEquals(expectedMessage, exception.getMessage());
        }
    }

    @Test
    void testNormalOutOfLowerBoundException() {
        try {
            FaceWord faceWord = FaceWord.parse("4/5/-3", 1);
            faceWord.checkIndices(5, 5, 5, 1, 1);
            Assertions.fail();
        } catch (FaceWordIndexException exception) {
            String expectedMessage = "Error parsing OBJ file on line: 1. Exception in face argument 1: normal index out of bounds.";
